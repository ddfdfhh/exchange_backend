...
let TradeQueueService = class TradeQueueService {
    constructor(tQueue) {
        this.tQueue = tQueue;
        this.job = null;
    }
    async initiateTradeJob(item) {
...
TradeQueueService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, bull_1.InjectQueue)('trade_queue')),
    __metadata("design:paramtypes", [Object])
], TradeQueueService);
exports.TradeQueueService = TradeQueueService;
//# sourceMappingURL=trade_queue.service.js.map